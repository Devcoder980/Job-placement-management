                                            ...
                                            <div className="registration-form text-dark text-start">
                                                <div className="grid lg:grid-cols-4  md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6">
                                                    <div className=" flex items-center filter-search-form relative filter-border">
                                                        ...
                                                        <input id="input" type="text" placeholder="Job title, keywords, or company" className={`w-full bg-white text-gray-700 lg:mr-4 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-${styles.backgroundTheme}-500 focus:shadow-outline-${styles.backgroundTheme}`} />
                                                    </div>
                                                    <div className=" flex items-center ">
                                                        <i className="uil uil-map-marker icons"></i>
                                                        <select className={` w-full  bg-white text-gray-700 border lg:mr-4 py-3 px-4 mb-3 leading-tight focus:outline-none  focus:shadow-outline-${styles.backgroundTheme} block  mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50`} data-trigger name="choices-location" id="choices-location" aria-label="Default select example">
